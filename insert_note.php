...
$sql = "insert into `".$image."notes`(`case_id`,`rad_id`,`note`,`x_coor`,`y_coor`,`width`,`height`,`submit_id`) VALUES('".$case_id."','".$rad."','".$anno_text."','".$anno_x."','".$anno_y."','".$anno_width."','".$anno_height."','".$submit_id."')";
