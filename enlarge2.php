    ...
    <body>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <center>
                ...
                <img src="<?php echo $row["imgRMLO"]?>" alt="RIGHT MLO" classs="img-fluid img-responsive" id="toAnnotate"  style="border:2px solid black;">
                ...
                ?>
                    ...
                    <div class="col-xs-9" style="padding-left: 7px;background-color: #111;">
                        <?php
                            ...
                            $rad = $_SESSION['rad_id'];
                            $ques_query = "select rmlomasses.mass, 
                                rmlomasses.shape, 
                                rmlomasses.margin, 
                                rmlomasses.density, 
                                rmlocalcification.calcification, 
                                rmlocalcification.typically, 
                                rmlocalcification.suspicious, 
                                rmlocalcification.distribution, 
                                rmloarchitectural.architectural, 
                                rmloasymmetries.asymmetries, 
                                rmlointramammary.intramammary, 
                                rmloskin.skin, 
                                rmlosolitary.solitary, 
                                rmloassociated.associated, 
                                rmlolocation.location
                                from
                                `rmlomasses`,
                                `rmlocalcification`, 
                                `rmloarchitectural`,
                                ...
                                `rmlolocation`
                                 where  
                                rmlomasses.case_id=".$case_id." 
                                and 
                                rmlocalcification.case_id=".$case_id." 
                                and 
                                rmloarchitectural.case_id=".$case_id."  
                                and
                                rmloasymmetries.case_id=".$case_id."  
                                and
                                rmlointramammary.case_id=".$case_id."  
                                and
                                rmloskin.case_id=".$case_id."  
                                and
                                rmlosolitary.case_id=".$case_id."
                                and
                                rmloassociated.case_id=".$case_id."
                                and
                                rmlolocation.case_id=".$case_id."
                                and
                                rmlomasses.rad_id = ".$rad."
                                and
                                rmlocalcification.rad_id= ".$rad." 
                                and
                                rmloarchitectural.rad_id= ".$rad."
                                and
                                rmloasymmetries.rad_id= ".$rad."
                                and
                                rmlointramammary.rad_id= ".$rad."
                                and
                                rmloskin.rad_id= ".$rad."
                                and
                                rmlosolitary.rad_id= ".$rad."
                                and
                                rmloassociated.rad_id= ".$rad."
                                and
                                rmlolocation.rad_id= ".$rad;
        ...
        <script>
            $('#btn_click').on('click', function() { window.location = "annotation.php?case_id="+<?php echo $row['case_id'];?>+"&image=RMLO"; });
        </script>
