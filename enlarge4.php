    ...
    <body>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
            <center>
                ...
                <img src="<?php echo $row["imgRCC"]?>" alt="RIGHT CC" classs="img-fluid img-responsive" id="toAnnotate"  style="border:2px solid black;">
                ...
                ?>
                    ...
                    <div class="col-xs-9" style="padding-left: 7px;background-color: #111;">
                        <?php
                            ...
                            $rad = $_SESSION['rad_id'];
                            $ques_query = "select rccmasses.mass, 
                                rccmasses.shape, 
                                rccmasses.margin, 
                                rccmasses.density, 
                                rcccalcification.calcification, 
                                rcccalcification.typically, 
                                rcccalcification.suspicious, 
                                rcccalcification.distribution, 
                                rccarchitectural.architectural, 
                                rccasymmetries.asymmetries, 
                                rccintramammary.intramammary, 
                                rccskin.skin, 
                                rccsolitary.solitary, 
                                rccassociated.associated, 
                                rcclocation.location
                                from
                                `rccmasses`,
                                `rcccalcification`, 
                                `rccarchitectural`,
                                ...
                                `rcclocation`
                                 where  
                                rccmasses.case_id=".$case_id." 
                                and 
                                rcccalcification.case_id=".$case_id." 
                                and 
                                rccarchitectural.case_id=".$case_id."  
                                and
                                rccasymmetries.case_id=".$case_id."  
                                and
                                rccintramammary.case_id=".$case_id."  
                                and
                                rccskin.case_id=".$case_id."  
                                and
                                rccsolitary.case_id=".$case_id."
                                and
                                rccassociated.case_id=".$case_id."
                                and
                                rcclocation.case_id=".$case_id."
                                and
                                rccmasses.rad_id = ".$rad."
                                and
                                rcccalcification.rad_id= ".$rad." 
                                and
                                rccarchitectural.rad_id= ".$rad."
                                and
                                rccasymmetries.rad_id= ".$rad."
                                and
                                rccintramammary.rad_id= ".$rad."
                                and
                                rccskin.rad_id= ".$rad."
                                and
                                rccsolitary.rad_id= ".$rad."
                                and
                                rccassociated.rad_id= ".$rad."
                                and
                                rcclocation.rad_id= ".$rad;
        ...
        <script>
            $('#btn_click').on('click', function() { window.location = "annotation.php?case_id="+<?php echo $row['case_id'];?>+"&image=RCC"; });
        </script>
